      ...
      <div className='bg-[#F9F1E7] w-full h-[100px] flex justify-between items-center px-6 lg:px-[100px]'>
        <div className='flex flex-row gap-6 lg:items-center lg:justify-center h-[37px]'>
          <div className='relative flex gap-2'>
            <img src={filter} className='w-7 h-7 cursor-pointer' alt='filter' onClick={() => setIsfilterOpen(!isfilterOpen)} />
                ...
                <div>
                  <label>
                    <input
                      type='checkbox'
                      value='all'
                      checked={selectedCategories && selectedCategories.includes('all')}
                ...
                <div>
                  <label>
                    <input
                      type='checkbox'
                      value='chair'
                      checked={selectedCategories && selectedCategories.includes('chair')}
                      onChange={handleCategoryChange}
                    />
                    Chair
                  </label>
                ...
                <div>
                  <label>
                    <input
                      type='checkbox'
                      value='sofa'
                      checked={selectedCategories && selectedCategories.includes('sofa')}
                      onChange={handleCategoryChange}
                    />
                    Sofa
                  </label>
                ...
                <div>
                  <label>
                    <input
                      type='checkbox'
                      value='lamp'
                      checked={selectedCategories && selectedCategories.includes('lamp')}
                      onChange={handleCategoryChange}
                    />
                    Lamp
                  </label>
                ...
                <div>
                  <label>
                    <input
                      type='checkbox'
                      value='table'
                      checked={selectedCategories && selectedCategories.includes('table')}
                      onChange={handleCategoryChange}
                    />
                    Table
                  </label>
                ...
                <div>
                  <label>
                    <input
                      type='checkbox'
                      value='vase'
                      checked={selectedCategories && selectedCategories.includes('vase')}
                      onChange={handleCategoryChange}
                    />
                    Vase
                  </label>
                ...
                <div>
                  <label>
                    <input
                      type='checkbox'
                      value='wardrobe'
                      checked={selectedCategories && selectedCategories.includes('wardrobe')}
                      onChange={handleCategoryChange}
                    />
                    Wardrobe
                  </label>
          ...
          <div className='flex flex-row gap-6'>
            <img src={grid} className='w-7 h-7 cursor-pointer' alt='grid' onClick={() => setViewMode('grid')} />
            <img src={list} className='w-7 h-7 cursor-pointer' alt='list' onClick={() => setViewMode('list')} />
          </div>
